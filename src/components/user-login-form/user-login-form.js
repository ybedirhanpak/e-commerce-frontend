            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <form>
                        ...
                        disabled={this.props.user.loginStatus.loginInProgress === 1 && 
                    ...
                    <h5 style={{marginTop:20}} className="text-center mb-4">Don't have an account yet ?</h5>
                ...
                {/* UI MESSAGES */}
                {
                    ...
                    (
                        <MDBContainer>
                            ...
                            <h5 className="alert-heading">Login in progress, please wait..</h5>
                            </MDBAlert>
                        </MDBContainer>
                    ) : (this.props.user.loginStatus.loginInProgress === 1 && 
                    ...
                    (
                        <MDBContainer>
                            ...
                            <h5 className="alert-heading">{this.props.user.loginStatus.loginResponse}</h5>
                            </MDBAlert>
                        </MDBContainer>
