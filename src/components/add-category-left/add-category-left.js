            ...
            <div className="row container">
                <div className="col-md-6">
                    ...
                    <div className="form-group">
                        ...
                        <select name="category1" className="form-control" onChange={this.onChange}>
                    ...
                    <form>
                        <div class="form-group col-md-6">
                            ...
                            <select multiple class="form-control" id="sel2" name="categories"  onChange={this.onChange} onClick={this.onClick}>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
