                ...
                <div className="price-filter">
                    ...
                    <div className="input-number price-min">
                        <input name="minPrice"
                            ...
                            placeholder="Min"
                        />
                        <span onClick={this.increaseMinClick} className="qty-up">+</span>
                        <span onClick={this.decreaseMinClick} className="qty-down">-</span>
                    </div>
                    <span>-</span>
                    <div className="input-number price-max">
                        <input name="maxPrice"
                            ...
                            placeholder="Max"
                        />
                        <span onClick={this.increaseMaxClick} className="qty-up">+</span>
                        <span onClick={this.decreaseMaxClick} className="qty-down">-</span>
                    </div>
